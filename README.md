...
# Frontend Mentor Challenge – Memory game

Power Apps Canvas application implementing a Memory game with solo and multiplayer modes for up to four players. Users can choose between number or icon tiles, select a 4x4 or 6x6 grid, and play through a responsive interface with interactive hover states.
...
| <img src="screenshots/desktop-design-p3.png" height="400"/> | <img src="screenshots/tablet-design-p3.png" height="400"/> | <img src="screenshots/mobile-design-p3.png" height="400"/> |
---

## 📊 Features

- Solo and multiplayer gameplay for up to four players
- Choose between numbers or icons for tiles
- Select a 4x4 or 6x6 game grid
